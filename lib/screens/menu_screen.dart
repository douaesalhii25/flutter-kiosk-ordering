...
class _MenuScreenState extends State<MenuScreen> {
  final List<FoodItem> items = [
    ...
    FoodItem(
      ...
      price: 10.0,
      category: 'Main',
      imagePath: 'assets/images/Spaghetti-Carbonara.jpg',
    ),
    FoodItem(
      id: '3',
      name: 'Lasagna',
    ...
    FoodItem(
      ...
      price: 12.0,
      category: 'Main',
      imagePath: 'assets/images/Risotto-alla-Milanese.jpg',
    ),
    FoodItem(
      id: '5',
      ...
      price: 9.0,
      category: 'Main',
      imagePath: 'assets/images/Fettuccine-Alfredo.jpg',
    ),
    FoodItem(
      id: '6',
      ...
      price: 9.0,
      category: 'Main',
      imagePath: 'assets/images/Penne-Arrabbiata.jpg',
    ),
    FoodItem(
      id: '7',
      ...
      price: 10.0,
      category: 'Main',
      imagePath: 'assets/images/Gnocchi-Sorrentina.jpg',
    ),
    FoodItem(
      id: '8',
      name: 'Osso Buco',
      price: 18.0,
      category: 'Main',
      imagePath: 'assets/images/Osso-Buco.jpg',
    ),
    FoodItem(
      id: '9',
      ...
      price: 10.0,
      category: 'Main',
      imagePath: 'assets/images/Eggplant-Parmigiana.jpg',
    ),
    ...
    FoodItem(
      ...
      price: 2.0,
      category: 'Beverage',
      imagePath: 'assets/images/Esspresso.jpg',
    ),
    FoodItem(
      id: '11',
      name: 'Cappuccino',
    ...
    FoodItem(
      ...
      price: 4.0,
      category: 'Beverage',
      imagePath: 'assets/images/Italian soda.jpg',
    ),
    FoodItem(
      id: '13',
      name: 'Red wine',
      price: 6.0,
      category: 'Beverage',
      imagePath: 'assets/images/Red wine.jpg',
    ),
    ...
    FoodItem(
      ...
      price: 4.0,
      category: 'Dessert',
      imagePath: 'assets/images/Cannoli.jpg',
    ),
    FoodItem(
      id: '16',
      name: 'Panna Cotta',
      price: 5.0,
      category: 'Dessert',
      imagePath: 'assets/images/Panna-Cotta.jpg',
    ),
    FoodItem(
      id: '17',
      name: 'Gelato',
    ...
    FoodItem(
      ...
      price: 4.0,
      category: 'Dessert',
      imagePath: 'assets/images/Sfogliatella.jpg',
    ),
    FoodItem(
      id: '19',
      name: 'Zeppole',
      price: 4.0,
      category: 'Dessert',
      imagePath: 'assets/images/Zeppole.jpg',
    ),
  ];
